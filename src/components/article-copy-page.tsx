...
function getPromptUrl(baseURL: string, url: string) {
  return `${baseURL}?q=${encodeURIComponent(
    `I’m looking at this article by Tushar Gaurav: ${url}.
    Help me understand the article. Be ready to explain concepts, give examples, or give a summary of the article.
  `
  )}`
}
